...
class _TemplatesState extends State<Templates> {
  ...
  // Get Patriotic Image
  void getPatrioticDay() {
    for (var patrioticImage in templateWithImageList) {
      if (patrioticImage['title'] == 'Patriotic Day') {
        patrioticDayList.add(patrioticImage);
      }
      setState(() {});
    }
  }
  ...
  // Get Festival Image
  void getfestivalsEventList() {
    for (var festivalsImage in templateWithImageList) {
      if (festivalsImage["title"] == "Festivals Event") {
        festivalsEventList.add(festivalsImage);
      }
      setState(() {});
    }
  }
