...
//                         borderSide:
//                             BorderSide(color: kPrimeryColor, width: 1.2),
                          ...
                          (index) {
                            return GestureDetector(
                              onTap: () async {
                                ...
                                print(
                                    " ---------- Template Name -------- $templateName");
                                homePosterDataList[index]["type"] == "Post"
                                    ? {
                                        await imageDialog(
                                          context,
                                          index,
                                    ...
                                    : Navigator.push(
                                        ...
                                        PageTransition(
                                          type: PageTransitionType
                                              .rightToLeftWithFade,
                                          child: EditVisitingCard(
                                            frontSide: homePosterDataList[index]
                                                ["image_2"],
                                            backSide: homePosterDataList[index]
                                                ["image_3"],
                                          ),
                                        ),
                                      );
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return GestureDetector(
                                    onTap: () async {
                                      templateName =
                                          festivalsEventList[index]["title"];
                                      templateSearchName =
                                          festivalsEventList[index]
                                              ["searchText"];
                                      print(
